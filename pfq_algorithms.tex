...
\newcommand{\Rag}[3] {\left(#1 \Big| \begin{array}{c} #2 \\ #3 \end{array} \right)}
...
\newcommand{\TwoArgS}[8] {( \begin{smallmatrix} #1 \\ #2 \end{smallmatrix} | \begin{smallmatrix} #3 \\ #4 \end{smallmatrix} | \begin{smallmatrix} #5 \\ #6 \end{smallmatrix} | {#7}, {#8})}

\newcommand{\appellFoneS}[6] {F_1 \ArgS{{#1};{#2},{#3}}{#4}{{#5},{#6}}}
\newcommand{\appellFone}[6]  {F_1 \Arg {{#1};{#2},{#3}}{#4}{{#5},{#6}}}

\newcommand{\appellFtwoS}[7] {F_2 \ArgS{{#1};{#2},{#3}}{{#4},{#5}}{{#6},{#7}}}
\newcommand{\appellFtwo}[7]  {F_2 \Arg {{#1};{#2},{#3}}{{#4},{#5}}{{#6},{#7}}}

\newcommand{\appellFthreeS}[7] {F_3 \ArgS{{#1},{#2};{#3},{#4}}{{#5}}{{#6},{#7}}}
\newcommand{\appellFthree}[7]  {F_3 \Arg {{#1},{#2};{#3},{#4}}{{#5}}{{#6},{#7}}}

\newcommand{\appellFfourS}[6]    {F_4 \ArgS{{#1};{#2}}{{#3},{#4}}{{#5},{#6}}}
\newcommand{\appellFfour}[6]  {F_4 \Arg {{#1};{#2}}{{#3},{#4}}{{#5},{#6}}}
...
\label{sec_appelf4_sol}
\begin{figure}[h]
\begin{center}
\begin{tikzpicture}[scale=0.75]
\fill[color=black!70](1., 0.)--(0.769586, 0.0150649)--(0.525827, 0.0755485)--(0.362324, 0.158457)--(0.25, 0.25)--(0.158457, 0.362324)--(0.0755485, 0.525827)--(0.0150649, 0.769586)--(0., 1.)--(-0.0150649, 0.769586)--(-0.0755485, 0.525827)--(-0.158457, 0.362324)--(-0.25, 0.25)--(-0.362324, 0.158457)--(-0.525827, 0.0755485)--(-0.769586, 0.0150649)--(-1., 0.)--(-0.769586, -0.0150649)--(-0.525827, -0.0755485)--(-0.362324, -0.158457)--(-0.25, -0.25)--(-0.158457, -0.362324)--(-0.0755485, -0.525827)--(-0.0150649, -0.769586)--(0., -1.)--(0.0150649, -0.769586)--(0.0755485, -0.525827)--(0.158457,-0.362324)--(0.25, -0.25)--(0.362324, -0.158457)--(0.525827, -0.0755485)--(0.769586, -0.0150649)--cycle;
\draw[-,black!30,thin](-1.0, 0.0)--(4.0, 0.0);
\draw[-,black!30,thin](0.0, -1.0)--(0.0, 3.0);
\draw[-,black!30,thin](0.5328999999999999, 2.9928999999999997)--(0.366025, 2.576025)--(0.2304, 2.1904)--(0.126025, 1.836025)--(0.05289999999999999, 1.5129)--(0.011024999999999997, 1.221025)--(0., 1.)--(0.015625, 0.765625)--(0.0625, 0.5625)--(0.140625, 0.390625)--(0.25, 0.25)--(0.390625, 0.140625)--(0.5625, 0.0625)--(0.765625, 0.015625)--(1., 0.)--(1.265625, 0.015625)--(1.5625, 0.0625)--(1.890625, 0.140625)--(2.25, 0.25)--(2.640625, 0.390625)--(3.0625, 0.5625)--(3.515625, 0.765625)--(4., 1.);
\draw[] (0, -1.25) node[black] {\scriptsize $f_{1,2,3,4}$};
\end{tikzpicture}
\begin{tikzpicture}[scale=0.75]
\fill[color=black!70](4., 1.)--(3.5, 0.7583426132260587)--(3., 0.5358983848622456)--(2.5, 0.3377223398316205)--(2., 0.1715728752538097)--(1.5, 0.05051025721682212)--(1.25, 0.013932022500210195)--(1., 0.)--(-1., 0.)--(-1., 2.)--(1., 2.)--(1.25, 1.9860679774997898)--(1.5, 1.9494897427831779)--(2., 1.8284271247461903)--(2.5, 1.6622776601683795)--(3., 1.4641016151377544)--(3.5, 1.2416573867739413)--cycle;
\draw[-,black!30,thin](-1.0, 0.0)--(4.0, 0.0);
\draw[-,black!30,thin](0.0, -1.0)--(0.0, 3.0);
\draw[-,black!30,thin](0.5328999999999999, 2.9928999999999997)--(0.366025, 2.576025)--(0.2304, 2.1904)--(0.126025, 1.836025)--(0.05289999999999999, 1.5129)--(0.011024999999999997, 1.221025)--(0., 1.)--(0.015625, 0.765625)--(0.0625, 0.5625)--(0.140625, 0.390625)--(0.25, 0.25)--(0.390625, 0.140625)--(0.5625, 0.0625)--(0.765625, 0.015625)--(1., 0.)--(1.265625, 0.015625)--(1.5625, 0.0625)--(1.890625, 0.140625)--(2.25, 0.25)--(2.640625, 0.390625)--(3.0625, 0.5625)--(3.515625, 0.765625)--(4., 1.);
\draw[] (0, -1.25) node[black] {\scriptsize $g_{1,2}$};
\end{tikzpicture}
\begin{tikzpicture}[scale=0.75]
\fill[color=black!70](0.171573, 0.)--(0.104249, 0.25)--(0.0505103, 0.5)--(0.013932, 0.75)--(0., 1.)--(0.013932, 1.25)--(0.0505103, 1.5)--(0.104249, 1.75)--(0.171573, 2.)--(-0.171573, 2.)--(-0.104249, 1.75)--(-0.0505103, 1.5)--(-0.013932, 1.25)--(0., 1.)--(-0.013932, 0.75)--(-0.0505103, 0.5)--(-0.104249, 0.25)--(-0.171573, 0.)--cycle;
\draw[-,black!30,thin](-1.0, 0.0)--(4.0, 0.0);
\draw[-,black!30,thin](0.0, -1.0)--(0.0, 3.0);
\draw[-,black!30,thin](0.5328999999999999, 2.9928999999999997)--(0.366025, 2.576025)--(0.2304, 2.1904)--(0.126025, 1.836025)--(0.05289999999999999, 1.5129)--(0.011024999999999997, 1.221025)--(0., 1.)--(0.015625, 0.765625)--(0.0625, 0.5625)--(0.140625, 0.390625)--(0.25, 0.25)--(0.390625, 0.140625)--(0.5625, 0.0625)--(0.765625, 0.015625)--(1., 0.)--(1.265625, 0.015625)--(1.5625, 0.0625)--(1.890625, 0.140625)--(2.25, 0.25)--(2.640625, 0.390625)--(3.0625, 0.5625)--(3.515625, 0.765625)--(4., 1.);
\draw[] (0, -1.25) node[black] {\scriptsize $p_{3,4}$};
\end{tikzpicture}
\begin{tikzpicture}[scale=0.75]
\fill[color=black!70](4., 1.)--(3.5, 0.7583426132260587)--(3., 0.5358983848622456)--(2.5, 0.3377223398316205)--(2., 0.1715728752538097)--(1.5, 0.05051025721682212)--(1.25, 0.013932022500210195)--(1., 0.)--(0.875, 0.004171306613029335)--(0.75, 0.017949192431122807)--(0.625, 0.04386116991581024)--(0.5, 0.08578643762690485)--(0.375, 0.15025512860841106)--(0.25, 0.25)--(0.125, 0.4178932188134524)--(0.03, 0.6835898384862246)--(0., 1.)--(-0.03, 0.6835898384862246)--(-0.125, 0.4178932188134524)--(-0.25, 0.25)--(-0.375, 0.15025512860841106)--(-0.5, 0.08578643762690485)--(-0.625, 0.04386116991581024)--(-0.75, 0.017949192431122807)--(-0.875, 0.004171306613029335)--(-1., 0.)--(-1., 2.)--(-0.875, 1.9958286933869707)--(-0.75, 1.9820508075688772)--(-0.625, 1.9561388300841898)--(-0.5, 1.9142135623730951)--(-0.375, 1.849744871391589)--(-0.25, 1.75)--(-0.125, 1.5821067811865475)--(-0.03, 1.3164101615137755)--(0., 1.)--(0.03, 1.3164101615137755)--(0.125, 1.5821067811865475)--(0.25, 1.75)--(0.375, 1.849744871391589)--(0.5, 1.9142135623730951)--(0.625, 1.9561388300841898)--(0.75, 1.9820508075688772)--(0.875, 1.9958286933869707)--(1., 2.)--(1.25, 1.9860679774997898)--(1.5, 1.9494897427831779)--(2., 1.8284271247461903)--(2.5, 1.6622776601683795)--(3., 1.4641016151377544)--(3.5, 1.2416573867739413)--cycle;
\draw[-,black!30,thin](-1.0, 0.0)--(4.0, 0.0);
\draw[-,black!30,thin](0.0, -1.0)--(0.0, 3.0);
\draw[-,black!30,thin](0.5328999999999999, 2.9928999999999997)--(0.366025, 2.576025)--(0.2304, 2.1904)--(0.126025, 1.836025)--(0.05289999999999999, 1.5129)--(0.011024999999999997, 1.221025)--(0., 1.)--(0.015625, 0.765625)--(0.0625, 0.5625)--(0.140625, 0.390625)--(0.25, 0.25)--(0.390625, 0.140625)--(0.5625, 0.0625)--(0.765625, 0.015625)--(1., 0.)--(1.265625, 0.015625)--(1.5625, 0.0625)--(1.890625, 0.140625)--(2.25, 0.25)--(2.640625, 0.390625)--(3.0625, 0.5625)--(3.515625, 0.765625)--(4., 1.);
\draw[] (0, -1.25) node[black] {\scriptsize $q_{3,4}$};
\end{tikzpicture}
\begin{tikzpicture}[scale=0.75]
\fill[color=black!70](0.5, 2.5)--(0.500557, 2.53393)--(0.502577, 2.57437)--(0.50684, 2.6238)--(0.514719, 2.68629)--(0.528898, 2.76931)--(0.555556, 2.88889)--(0.614047, 3.09164)--(1., 4.)--(0.477592, 2.95518)--(0.333333, 2.66667)--(0.240408, 2.48082)--(0.171573, 2.34315)--(0.116963, 2.23393)--(0.0717968, 2.14359)--(0.0333705, 2.06674)--(0., 2.)--(0., 0.)--(0.0333705, 0.)--(0.0717968,0.)--(0.116963, 0.)--(0.171573, 0.)--(0.240408, 0.)--(0.333333,0.)--(0.477592, 0.)--(1., 0.)--(0.614047, 0.136455)--(0.555556, 0.222222)--(0.528898, 0.28849)--(0.514719, 0.343146)--(0.50684, 0.389877)--(0.502577, 0.430781)--(0.500557, 0.467186)--(0.5, 0.5)--(0.382813, 0.507813)--(0.28125, 0.53125)--(0.195313, 0.570313)--(0.125, 0.625)--(0.0703125, 0.695313)--(0.03125, 0.78125)--(0.0078125, 0.882813)--(0., 1.)--(0.0078125, 1.13281)--(0.03125, 1.28125)--(0.0703125, 1.44531)--(0.125, 1.625)--(0.195313, 1.82031)--(0.28125, 2.03125)--(0.382813, 2.25781)--cycle;
\draw[-,black!30,thin](-1.0, 0.0)--(4.0, 0.0);
\draw[-,black!30,thin](0.0, -1.0)--(0.0, 3.0);
\draw[-,black!30,thin](0.5328999999999999, 2.9928999999999997)--(0.366025, 2.576025)--(0.2304, 2.1904)--(0.126025, 1.836025)--(0.05289999999999999, 1.5129)--(0.011024999999999997, 1.221025)--(0., 1.)--(0.015625, 0.765625)--(0.0625, 0.5625)--(0.140625, 0.390625)--(0.25, 0.25)--(0.390625, 0.140625)--(0.5625, 0.0625)--(0.765625, 0.015625)--(1., 0.)--(1.265625, 0.015625)--(1.5625, 0.0625)--(1.890625, 0.140625)--(2.25, 0.25)--(2.640625, 0.390625)--(3.0625, 0.5625)--(3.515625, 0.765625)--(4., 1.);
\draw[] (0, -1.25) node[black] {\scriptsize $r_{3,4}$};
\end{tikzpicture}
\end{center}
\caption{real convergence regions in $(x,y)$ for the various solutions}
\label{fig_f4_region}
\end{figure}
...
\begin{flalign*}
&\begin{alignedat}{2}
q_3 &= \tfrac{\Gamma(c_1)}{2\Gamma(a+b-c_2)} (-x)^{\tfrac{c_2-a-b}{2}} \sum_{n=0}^{\infty} && \tfrac{\Gamma(\tfrac{a+b-n-c_2}{2}) \Gamma
   (\tfrac{a-b+n-c_2+2}{2}) \Gamma
   (\tfrac{-a+b+n-c_2+2}{2})}{\Gamma
   (\tfrac{a-b-n-c_2+2}{2}) \Gamma
   (\tfrac{-a+b-n-c_2+2}{2}) \Gamma(\tfrac{-a-b+n+2c_1+c_2}{2})} \tfrac{(-\sqrt{-x})^n}{n!} \\
   &  && \quad \quad \Head4F3 \ArgS{\tfrac{a+b-c_2-n}{2},\tfrac{a+b-2c_1-c_2-n+2}{1},\tfrac{a-b+c_2+n}{2},\tfrac{-a+b+c_2+n}{2}}{
   \tfrac{1}{2},\tfrac{a-b+c_2-n}{2},\tfrac{-a+b+c_2-n}{2}}{\tfrac{(1-y)^2}{4 x}}\\
   & && + \tfrac{\Gamma(\tfrac{a+b-n-c_2+1}{2}) \Gamma
   (\tfrac{a-b+n-c_2+1}{2}) \Gamma
   (\tfrac{-a+b+n-c_2+1}{2})}{\Gamma
   (\tfrac{a-b-n-c_2+1}{2}) \Gamma
   (\tfrac{-a+b-n-c_2+1}{2}) \Gamma(\tfrac{-a-b+n+2
   c_1+c_2-1}{2})} \tfrac{(1-y) (-\sqrt{-x})^{n-1}}{n!}\\
   & && \quad \quad \Head4F3 \ArgS{\tfrac{a+b-c_2-n+1}{2},\tfrac{a+b-2
   c_1-c_2-n+3}{2},\tfrac{a-b+c_2+n+1}{2},\tfrac{-a+b+c_2+n+1}{2}}{\tfrac{3}{2},\tfrac{a-b+c_2-n+1}{2},\tfrac{-a+b+c_2-n+1}{2}}{\tfrac{(1-y)^2}{4 x}}
   \text{,}
\end{alignedat}
\\
&q_4 = x^{1-c_1} q_3 \ArgS{1+a-c_1;1+b-c_1}{2-c_1,c_2}{x,y} \text{.}
\end{flalign*}
Finally, approaching $(0,1)$ along $\Delta=0$ gives two more solutions in $(z_1,z_2)=(\frac{\Delta}{(1-y+x)^2}, 1-y+x)$ converging for $|z_1|<1, |z_2|(1+\sqrt{|z_1|})<2$.
\begin{equation*}
\begin{alignedat}{3}
r_3 &=       &                 (1-y+x)^{1-c_1+\sigma} & {\textstyle\sum}_{m,n=0}^{\infty} \alpha_{m,n} \Delta^m (1-y+x)^{n-2m}\text{,}\\
r_4 &= \Delta&^{\sigma+\frac12}(1-y+x)^{-c_1 -\sigma} & {\textstyle\sum}_{m,n=0}^{\infty} \beta_{m,n} \Delta^m (1-y+x)^{n-2m}\text{.}
\end{alignedat}
\end{equation*}
The sequences $\alpha_{m,n}$ and $\beta_{m,n}$ are not hypergeometric, but are fairly close:
\begin{align*}
\tfrac{(2 m - 2 n - 2 \sigma - 1) \alpha _{m,n}+(n + \sigma + c_2-1) \alpha_{m,n-1}}{2 m - n - \sigma + c_1 - 2}
&=\tfrac{(2 m - n - \sigma + c_1 - 3)\alpha _{m-1,n}+(n + \sigma + c_2 - 1) \alpha_{m-1,n-1}}{2m}\\
\tfrac{2 (n-m) \beta _{m,n}-(n+c_2+\sigma -1) \beta_{m,n-1}}{2 m-n+c_1+\sigma -1}
&=\tfrac{(n-2m-\sigma-c_1 +2)\beta _{m-1,n}-(n+c_2+\sigma -1) \beta _{m-1,n-1}}{2m+2 \sigma +1}
\end{align*}
Different recursions must be used along $m=0$ and $m=n$, respectively.
\begin{remark}
An attempt should be made at simplifying $r_3$ and $r_4$. note $\sum_{n=0}^{\infty} \beta_{0,n} z_2^n = (1-\tfrac{z_2}{2})^?$.
\end{remark}
...
%&+ 0 \cdot x^{2 - 2 c} \Head3F2 \ArgS{2 + 2 a - 2 c, 2 + 2 b - 2 c, \frac32 - c}{3 - 2 c, \frac52 + a + b - 2 c}{x}\text{,}\\
...
\quad 1. increment a numerator parameter by $1$ a long as it didn't start at $0$\\
\quad 2. decrement a denominator parameter as long as it doesn't end up at $0$\\
\quad 3. decrement a numerator parameter as long as it doesn't end up at a denominator parmeter\\
\quad 4. increment a denominator parameter as long as it didn't start at a numerator parmeter
